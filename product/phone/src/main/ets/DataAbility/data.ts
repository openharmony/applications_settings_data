    ...
    switch (settingsKey) {
        ...
        case SettingsDataConfig.SettingsKey.SETTINGS_GENERAL_DEVICE_NAME:
        {
            try {
                ...
                console.log(TAG + 'settings bluetooth_name res = ' + result)
            } catch (err) {
                console.log(TAG + 'settings bluetooth_name failed, error = ' + JSON.stringify(err));
            }
        }break
        default :
            {
                console.log(TAG + settingsKey+' key is not brightness or audio or deviceName');
            }
    }
}
...
export default {
    onInitialized(abilityInfo) {
        console.log(TAG + 'onInitialize getContext start');
        ...
        if(context != null) {
            ...
            console.log(TAG + 'onInitialize context error!');
        }
    },
